...
li a.active {
  ...
  background-color: mediumblue;
    ...
    <ul>
        ...
        <li><a  class="active" href="employeeSignIn.php">Employee</a></li>
        <li><span align='right' ><a href="userSignIn.php">Login</a></span></li>
...
if(isset($_POST['submit']))
{
    ...
    $query="select * from employee_info where emp_id='$un' and password='$pwd'";
