...
<header style="margin-top:-8px; margin-left:-8px;margin-right:-8px;">
        ...
        <br>
        <h2 align='center' style="color:black;">Within Bank</h2>
        <form method='POST'>
        <table align='center' cellpadding=10px id='t11'>
            ...
            <tr>
                <td colspan='2' align='center'><br><center><input type='submit' name='sub' id='s' value='Transfer'></center></td>
            </tr>
        </table>
        
        </form>
        <br>
        <center><h3><a href='obank.php'><u style='color:blue'>Outside Bank</u></a></center>
        <br><br>
...
if(isset($_POST['sub']))
{
    ...
    {
        $zzz=$zzz+1;
        ?><script>alert("Sorry, Beneficiary Account No doesnt match with the confirmed one");</script><?php
    }
    ...
    {
        $zzz=$zzz+1;
        ?><script>alert("Sorry, this account no doesn't exist");</script><?php
    }
    //echo $zzz;
    if($zzz==0)
    {
